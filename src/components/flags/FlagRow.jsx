...
export function FlagRow({
  ...
  const summary = total
    ? `${service.enabledCount}/${total} enabled`
    : "No flags";
      ...
      <div className="service-row">
        ...
        >
          ...
          <span className="service-row__lead">
            <span className="service-row__service-key">
              {service.serviceKey}
            </span>
            <span className="service-row__description">
              {service.description}
            </span>
            <span className="service-row__summary service-row__summary--inline">
              {summary}
            </span>
          </span>
        </button>
        ...
        <div
          className="service-row__aside"
          onClick={(e) => e.stopPropagation()}
        >
          <span className="service-row__summary service-row__summary--aside">
            {summary}
          </span>
        ...
        <div id={servicePanelId} className="endpoint-list">
          {service.endpoints.map((endpoint) => (
            <div key={endpoint.flag_name} className="endpoint-row">
              ...
              >
                <span className="endpoint-row__lead">
                  <span className="endpoint-row__key-line">
                    ...
                    <span
                      className={`endpoint-row__flag ${endpoint.enabled ? "is-on" : ""}`}
                    >
                      {endpoint.flag_name}
                    </span>
                  </span>
                  <span className="endpoint-row__description">
                ...
                <span className="endpoint-row__deps" aria-label="Dependencies">
                  {endpoint.depends_on?.length ? (
                    ...
                    <span className="dependency-chip dependency-chip--empty">
                      —
                    </span>
                  )}
                </span>
              ...
              <div
                className="endpoint-row__controls"
                onClick={(e) => e.stopPropagation()}
              >
                <ToggleSwitch
                ...
                <span className="endpoint-row__status" aria-hidden="true">
                  <span
                    className={`status-dot ${endpoint.enabled ? "status-dot--on" : "status-dot--off"}`}
                  />
                </span>
              </div>
            </div>
